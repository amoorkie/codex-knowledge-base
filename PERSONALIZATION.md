...
- If a required skill is missing locally and no approved skills repository is configured, say so briefly and continue with the best fallback.
...
2. Relevant local knowledge base entry
3. Sync or update missing/outdated knowledge base from approved repository
4. Normal local tools
5. Fallback reasoning without local skill or knowledge base
